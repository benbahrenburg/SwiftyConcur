...
public extension ConcurClient {
  ...
  public func attendeesGet(options: [String : AnyObject?], callback: (error: String!, returnValue: ConcurCollection<Attendee>!) -> Void) {
    let request = ConcurClient.getHTTPRequest("api/v3.0/expense/attendees", options: options)
    ConcurClient.sendRequest(request, callback: callback)
  }
  
  public func attendeesPost(options: [String : AnyObject?], callback: (error: String!, returnValue: ConcurCollection<Attendee>!) -> Void) {
    let request = ConcurClient.postHTTPRequest("api/v3.0/expense/attendees", options: options)
    ConcurClient.sendRequest(request, callback: callback)
  }
  
  public func attendeesPut(options: [String : AnyObject?], callback: (error: String!, returnValue: ConcurCollection<Attendee>!) -> Void) {
    let request = ConcurClient.putHTTPRequest("api/v3.0/expense/attendees", options: options)
    ConcurClient.sendRequest(request, callback: callback)
  }
  
  public func attendeesDelete(options: [String : AnyObject?], callback: (error: String!, returnValue: ConcurCollection<Attendee>!) -> Void) {
    let request = ConcurClient.deleteHTTPRequest("api/v3.0/expense/attendees", options: options)
    ConcurClient.sendRequest(request, callback: callback)
  }
